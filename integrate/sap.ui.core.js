 ...
 * @memberOf sap.ui
 */
sap.ui.view = function(sId,vView,sType) { return new sap.ui.core.mvc.View(); };
 ...
 */
sap.ui.core.Component.prototype.activateCustomizing = function(sComponentName) { return null; };
 ...
 * @experimental Since 1.15.1. Implementation might change.
 */
sap.ui.core.Component.prototype.deactivateCustomizing = function(sComponentName) { return null; };
 ...
 * @public
 */
sap.ui.core.Core.prototype.attachIntervalTimer = function(fnFunction,oListener) { return null; };
 ...
 * @public
 */
sap.ui.core.Core.prototype.detachIntervalTimer = function(fnFunction,oListener) { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.attachClosed = function(fnFunction,oListener) { return new sap.ui.core.Popup(); };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.attachOpened = function(fnFunction,oListener) { return new sap.ui.core.Popup(); };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.close = function(iDuration) { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.destroy = function() { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.getFollowOf = function() { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.getOpenState = function() { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.isOpen = function() { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.open = function(iDuration,my,at,of,offset,collision,followOf) { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.setFollowOf = function(a) { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.setInitialFocusId = function(sId) { return null; };
 ...
 * @public
 */
sap.ui.core.Popup.prototype.setPosition = function(my,at,of,offset,defines) { return new sap.ui.core.Popup(); };
 ...
 * @protected
 */
sap.ui.core.routing.HashChanger.prototype.destroy = function() { return null; };
 ...
 * @protected
 */
sap.ui.core.routing.HashChanger.prototype.fireHashChanged = function(newHash,oldHash) { return null; };
 ...
 */
sap.ui.core.routing.HashChanger.prototype.init = function() { return null; };
 ...
 * @public
 */
sap.ui.core.routing.HashChanger.prototype.replaceHash = function(sHash) { return null; };
 ...
 * @protected
 */
sap.ui.core.routing.HashChanger.prototype.replaceHashChanger = function(oHashChanger) { return null; };
 ...
 * @public
 */
sap.ui.core.routing.HashChanger.prototype.setHash = function(sHash) { return null; };
 ...
 *        oConfig.view:              The name of a view that will be created, the first time this route will be matched. To place the view into a Control use the targetAggregation and targetControl. Views will only be created once.
 *        oConfig.viewType:          The type of the view that is going to be created
 *        oConfig.viewPath:          A prefix that will be prependet in front of the view eg: view is set to "myView" and viewPath is set to "myApp" - the created view will be "myApp.myView".
 *        oConfig.targetParent:      the id of the parent of the targetControl - if targetParent is undefined and the route is a subroute, the targetControl of the parent route is taken.
 *        oConfig.targetControl:     Views will be put into a container Control, this might be a Shell control or a NavContainer? if working with mobile, or any other container. The id of this control has to be put in here.
 *        oConfig.targetAggregation: The name of an aggregation of the targetControl, that contains views. Eg: a NavigationContainer? has an aggregation Pages , another Example is the Shell it has Content.
 *        oConfig.clearTarget:       Defines a boolean that can be passed to specify if the aggregation should be cleared before adding the View to it.
 ...
 * 
 */
sap.ui.core.routing.Route = function(oParent,oConfig,oParent) {};
/**
 * 
 ...
 * @public
 */
sap.ui.core.routing.Route.prototype.getURL = function(Parameters) { return ""; };
 ...
 * 
 */
sap.ui.core.routing.Router = function(Default,A) {};
/**
 * 
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.addRoute = function(oConfig,oParent) { return null; };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.destroy = function() { return null; };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.detachRouteMatched = function(fnFunction,oListener,oListener) { return new sap.ui.core.routing.Router(); };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.detachViewCreated = function(fnFunction,oListener,oListener) { return new sap.ui.core.routing.Router(); };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.getRouter = function(Name) { return new sap.ui.core.routing.Router(); };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.getURL = function(Name,Parameters) { return ""; };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.getView = function(sViewName,sViewType) { return new sap.ui.core.mvc.View(); };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.initialize = function() { return null; };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.navTo = function(sName,oParameters,bReplace) { return ""; };
 ...
 * @public
 */
sap.ui.core.routing.Router.prototype.register = function(Name) { return null; };
 ...
 * @public
 */
sap.ui.core.UIComponent.prototype.getRouterFor = function(either) { return new sap.ui.core.routing.Router(); };
 ...
 * 
 */
sap.ui.core.ws.SapPcpWebSocket = function(sUrl) {};
/**
 * 
 ...
 * 
 */
sap.ui.core.ws.WebSocket = function(sUrl) {};
/**
 * 
 ...
 * @public
 */
sap.ui.core.ws.WebSocket.prototype.close = function(oControlEvent) { return null; };
 ...
 * @public
 */
sap.ui.core.ws.WebSocket.prototype.error = function(oControlEvent) { return null; };
 ...
 * @public
 */
sap.ui.core.ws.WebSocket.prototype.message = function(oControlEvent) { return null; };
 ...
 * @public
 */
sap.ui.core.ws.WebSocket.prototype.open = function(oControlEvent) { return null; };
 ...
 * @public
 */
sap.ui.core.ws.WebSocket.prototype.close = function() { return new sap.ui.core.ws.WebSocket(); };
 ...
 * @public
 */
sap.ui.core.ws.WebSocket.prototype.getInterface = function() { return null; };
 ...
 * @memberOf jQuery.support
 */
jQuery.support.hasFlexBoxSupport = null;
 ...
 * @public
 * @memberOf sap.ui.core.routing.HistoryDirection
 */
sap.ui.core.routing.HistoryDirection.Backwards = null;
 ...
 * @memberOf sap.ui.core.routing.HistoryDirection
 */
sap.ui.core.routing.HistoryDirection.Forwards = null;
 ...
 * @memberOf sap.ui.core.routing.HistoryDirection
 */
sap.ui.core.routing.HistoryDirection.NewEntry = null;
 ...
 * @memberOf sap.ui.core.routing.HistoryDirection
 */
sap.ui.core.routing.HistoryDirection.Unknown = null;
 ...
 */
sap.ui.core.ws.ReadyState.CLOSED = null;
 ...
 * @memberOf sap.ui.core.ws.ReadyState
 */
sap.ui.core.ws.ReadyState.CLOSING = null;
 ...
 * @memberOf sap.ui.core.ws.ReadyState
 */
sap.ui.core.ws.ReadyState.CONNECTING = null;
 ...
 * @memberOf sap.ui.core.ws.ReadyState
 */
sap.ui.core.ws.ReadyState.OPEN = null;
